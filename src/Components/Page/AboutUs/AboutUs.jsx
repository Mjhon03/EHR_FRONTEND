    ...
    <>
      ...
      <div className="about-slogan">
        ...
        <div className="text-slogan-container">
          <h2>Nuestra idea</h2>
          <p>Esta nace de generar facilidad al usuario en la tarea de emprender la busqueda de un inmueble, con Easy House Rent el ezfuerzo se minimiza obteniendo diversas opciones en cuestion de segundos , eligiendo la de tu preferencia y contactando directamente con su propietario</p>
        </div>
      </div>
